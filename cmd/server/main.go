...
func main() {
	...
	flag.BoolVar(&vercelLogin, "vercel-login", false, "Login to Vercel (FX) using device code flow")
	flag.BoolVar(&vercelLogin, "fx-login", false, "Alias for -vercel-login")
	...
	commandMode := vertexImport != "" || antigravityLogin || codexLogin || codexDeviceLogin || claudeLogin || kimiLogin || xaiLogin || vercelLogin
